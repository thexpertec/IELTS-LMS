  ...
  return (
    <footer className="bg-primary text-primary-foreground py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="font-serif font-bold text-xl tracking-tight">OneSoft LMS</span>
            </div>
          ...
          <div>
            <h4 className="font-bold mb-6 font-serif">Platform</h4>
          ...
          <div>
            <h4 className="font-bold mb-6 font-serif">Solutions</h4>
            <ul className="space-y-4 text-sm text-primary-foreground/70">
          ...
          <div>
            <h4 className="font-bold mb-6 font-serif">Contact</h4>
            <ul className="space-y-4 text-sm text-primary-foreground/70">
        ...
        <div className="border-t border-primary-foreground/10 mt-16 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-primary-foreground/50">
